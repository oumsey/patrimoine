...
<div class="container-fluid">  
                    <div class="page-title-box">
                        ...
                        <div class="row align-items-center ">
                            <div class="col-md-8">
                                <div class="page-title-box">
                                    <h4 class="page-title">Liste des type de rubrique</h4>
                                    <ol class="breadcrumb">
                                       
                                        <li class="breadcrumb-item">
                                            <a href="javascript:void(0);">Paramètres</a>
                                        </li>
                                        <li class="breadcrumb-item active">Liste des types de rubrique</li>
                                    </ol>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="{{ url('/admin/typerubrique/create') }}" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-container="modal-container" >Ajouter une catégorie</a>
