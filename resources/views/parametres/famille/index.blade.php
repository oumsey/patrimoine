...
<div class="container-fluid">  
                    <div class="page-title-box">
                        ...
                        <div class="row align-items-center ">
                            <div class="col-md-8">
                                <div class="page-title-box">
                                    <h4 class="page-title">Liste des Familles</h4>
                                    <ol class="breadcrumb">                                        
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="{{ url('/famille/create') }}" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-container="modal-container" >Ajouter une Famille</a>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <?php foreach ($familles as $famille) : ?>
                                            <tr><td><input class="my_checkbox" type="checkbox" name="check[]" id="<?php echo $famille->FAM_NUM ?>" > </td>
                                                <td>{{$famille->FAM_NUM}}</td>
                                                <td>{{$famille->FAM_NOM}}</td>
                                                <td>{{$famille->FAM_EMAIL}}</td>
                                                <td>{{$famille->FAM_NOMRESPO}}</td>  
                                                <td><a href="<?php echo url("famille/$famille->FAM_NUM/edit") ?>"  data-toggle="modal" data-container="modal-container"  class="waves-effect waves-light"><i class="typcn typcn-pencil text-success"></i></a>
                                                &nbsp;  | &nbsp;
                                                <a href ="#" data-toggle="tooltip" title="Supprimer!"
                                                                        onclick="deleteItem('<?= $famille->FAM_NUM ?>','<?= url("/famille/delete/$famille->FAM_NUM") ?>','<?= url("/famille") ?>')">
                                        ...
                                        <tfooter>
                                            <tr >
                                                <th colspan="5">
                                                    <button type="button" onclick="deleteItems('<?= url("/famille/deletes") ?>', '<?= url("/devise") ?>')" class="btn btn-danger btn-icon btn-rounded" id="btn_delete_all">
