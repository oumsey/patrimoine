                    ...
                    <div class="page-title-box">
                        ...
                        <div class="row align-items-center ">
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="{{ url('/pays/create') }}" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-container="modal-container" >Ajouter un Pays</a>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <?php foreach ($payss as $pays) : ?>
                                            <tr><td><input class="my_checkbox" type="checkbox" name="check[]" id="<?php echo $pays->PAY_NUM ?>" > </td>
                                                <td>{{$pays->PAY_NUM}}</td>
                                                <td>{{$pays->PAY_NOM}}</td>
                                                <td>{{$pays->PAY_NATIONALITE}}</td>  
                                                <td><a href="<?php echo url("pays/$pays->PAY_NUM/edit") ?>"  data-toggle="modal" data-container="modal-container"  class="waves-effect waves-light"><i class="typcn typcn-pencil text-success"></i></a>
                                                &nbsp;  | &nbsp;
                                                <a href ="#" data-toggle="tooltip" title="Supprimer!"
                                                                        onclick="deleteItem('<?= $pays->PAY_NUM ?>','<?= url("/pays/delete/$pays->PAY_NUM") ?>','<?= url("/pays") ?>')">
                                        ...
                                        <tfooter>
                                            <tr >
                                                <th colspan="5">
                                                    <button type="button" onclick="deleteItems('<?= url("/pays/deletes") ?>', '<?= url("/pays") ?>')" class="btn btn-danger btn-icon btn-rounded" id="btn_delete_all">
