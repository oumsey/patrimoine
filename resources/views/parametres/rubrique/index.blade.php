                    ...
                    <div class="page-title-box">
                        ...
                        <div class="row align-items-center ">
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="{{ url('/quartier/create') }}" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-container="modal-container" >Ajouter un Quartier</a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                        <?php foreach ($quartiers as $quar) : ?>
                                            <tr><td><input class="my_checkbox" type="checkbox" name="check[]" id="<?php echo $quar->QRT_NUM ?>" > </td>
                                                <td>{{$quar->QRT_NUM}}</td>
                                                <td>{{$quar->QRT_NOM}}</td>
                                                <td>{{$quar->commune->COM_NOM}}</td>  
                                                <td><a href="<?php echo url("quartier/$quar->QRT_NUM/edit") ?>"  data-toggle="modal" data-container="modal-container"  class="waves-effect waves-light"><i class="typcn typcn-pencil text-success"></i></a>
                                                &nbsp;  | &nbsp;
                                                <a href ="#" data-toggle="tooltip" title="Supprimer!"
                                                                        onclick="deleteItem('<?= $quar->QRT_NUM ?>','<?= url("/quartier/delete/$quar->QRT_NUM") ?>','<?= url("/quartier") ?>')">
                                        ...
                                        <tfooter>
                                            <tr >
                                                <th colspan="5">
                                                    <button type="button" onclick="deleteItems('<?= url("/quartier/deletes") ?>', '<?= url("/quartier") ?>')" class="btn btn-danger btn-icon btn-rounded" id="btn_delete_all">
