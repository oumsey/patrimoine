...
<div class="container-fluid">  
                    <div class="page-title-box">
                        ...
                        <div class="row align-items-center ">
                            <div class="col-md-8">
                                <div class="page-title-box">
                                    <h4 class="page-title">Liste des Communes</h4>
                                    <ol class="breadcrumb">                                        
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="{{ url('/commune/create') }}" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-container="modal-container" >Ajouter une Commune</a>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <?php foreach ($communes as $com) : ?>
                                            <tr><td><input class="my_checkbox" type="checkbox" name="check[]" id="<?php echo $com->COM_NUM ?>" > </td>
                                                <td>{{$com->COM_NUM}}</td>
                                                <td>{{$com->COM_NOM}}</td>
                                                <td>{{$com->ville->VIL_NOM}}</td>  
                                                <td><a href="<?php echo url("commune/$com->COM_NUM/edit") ?>"  data-toggle="modal" data-container="modal-container"  class="waves-effect waves-light"><i class="typcn typcn-pencil text-success"></i></a>
                                                &nbsp;  | &nbsp;
                                                <a href ="#" data-toggle="tooltip" title="Supprimer!"
                                                                        onclick="deleteItem('<?= $com->COM_NUM ?>','<?= url("/commune/delete/$com->COM_NUM") ?>','<?= url("/commune") ?>')">
                                        ...
                                        <tfooter>
                                            <tr >
                                                <th colspan="5">
                                                    <button type="button" onclick="deleteItems('<?= url("/commune/deletes") ?>', '<?= url("/commune") ?>')" class="btn btn-danger btn-icon btn-rounded" id="btn_delete_all">
