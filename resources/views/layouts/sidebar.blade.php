                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="{{ url('/ville') }}">Ville</a></li>
